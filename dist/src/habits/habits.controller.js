...
__decorate([
    (0, common_1.Get)('new'),
    (0, common_1.Render)('habits/new'),
    __param(0, (0, common_1.Query)('auth')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], HabitsController.prototype, "createForm", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, common_1.Render)('habits/show'),
...
__decorate([
    ...
    (0, common_1.Render)('habits/edit'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Query)('auth')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], HabitsController.prototype, "editForm", null);
